...
- 上書き関係がある場合は、新ADRに `Supersedes`、旧ADRに `Superseded by` を記載する
...
| ADR-0004 | [テレフォニーとWSゲートウェイの選定](./0004-telephony-and-ws-gateway.md) | Accepted（一部上書き: ADR-0009） |
...
| ADR-0009 | [WSゲートウェイでのPCMU変換をMVP要件とする](./0009-pcmu-conversion-at-gateway.md) | Accepted |
